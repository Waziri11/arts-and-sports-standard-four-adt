# Arts and Sports Pupil's Book Standard Four — ADT Bundle Reference
...
**Arts and Sports Pupil's Book Standard Four** — This is an English-language primary school textbook from Tanzania, published by the Tanzania Institute of Education for Standard Four pupils, roughly equivalent to upper primary/around Grade 4. It introduces basic arts and physical education skills through chapters on acting, singing and musical instruments, drawing, clay modelling, physical exercises, traditional and modern games, and participation in exhibitions, performances, and sports competitions. The book uses a practical, activity-based teaching approach with exercises, illustrations, and group tasks, emphasizing creativity, performance, teamwork, health, confidence, and community values in a Tanzanian context.
...
```
ARTS---SPORTS-STD--GIVEN-ERC-FINAL-SEPTEMBER17/
├── adt/                              # THE WEB APP
...
├── ARTS---SPORTS-STD--GIVEN-ERC-FINAL-SEPTEMBER17.db                    # SQLite database (pipeline state)
├── ARTS---SPORTS-STD--GIVEN-ERC-FINAL-SEPTEMBER17.pdf                   # Original source PDF
...
[
  ...
  { "section_id": "pg008_sec001", "href": "pg008_sec001.html", "page_number": 2 }
]
```
...
{
  "pg001_gp001_tx001": "",
  "pg001_im008": "Top section of the green approval certificate showing the heading for the United Republic of Tanzania.",
  "gl001": "academic",
  "gl001_def": "related to school learning and study"
}
```
...
```json
{
  "academic": {
    "word": "academic",
    "definition": "related to school learning and study",
    "variations": ["academic","academics"],
    "emoji": "📚🏫"
  }
}
```
...
```json
{
  "title": "Arts and Sports Pupil's Book Standard Four",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en"
...
| Original PDF | `ARTS---SPORTS-STD--GIVEN-ERC-FINAL-SEPTEMBER17.pdf` |
| Pipeline database | `ARTS---SPORTS-STD--GIVEN-ERC-FINAL-SEPTEMBER17.db` (SQLite) |
